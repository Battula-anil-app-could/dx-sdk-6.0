...
- Dropped crate: `dharitrix-wasm-output`. There is no equivalent crate, its job was passed to the individual `wasm` crates.
- `ManagedVec` supports sorting and deduplication.
- `migrateUserName` builtin function mock.

## [dharitrix-wasm 0.38.0, dharitrix-codec 0.16.0, mandos 0.18.0] - 2022-12-15
...
## [dharitrix-wasm 0.37.0, dharitrix-codec 0.15.0] - 2022-12-09
...
- `dharitrix-codec` refactor: removed `TopEncodeNoErr`, `NestedEncodeNoErr` and `TypeInfo`
...
## [dharitrix-wasm 0.35.0, dharitrix-codec 0.13.0, mandos 0.17.0] - 2022-09-20
...
## [dharitrix-wasm 0.34.1] - 2022-07-19
- `#[only_admin]` annotation
- Safer BigUint/BigInt conversions
- Added and published `price-aggregator` and `wegld-swap` core contracts.

## [dharitrix-wasm 0.34.0, dharitrix-codec 0.12.0, mandos 0.16.0, dharitrix-interact-snippets 0.1.0] - 2022-07-08
- Major refactor of the mandos-rs infrastructure.
	- High-level Mandos objects moved to dharitrix-wasm-debug;
	- The `mandos` crate no longer depends on `dharitrix-wasm-debug` (as originally intended and implemented);
	- Typed mandos contract call objects, for better call syntax.
	- More syntactic sugar for writing mandos calls.
- The first version of dharitrix-interact-snippets, which can be used to write short blockchain interactor programs.
...
## [dharitrix-wasm 0.33.1, mandos 0.15.1] - 2022-06-24
- CodecSelf for BigInt

## [dharitrix-wasm 0.33.0, mandos 0.15.0] - 2022-06-20
...
## [dharitrix-wasm 0.32.0, mandos 0.14.0] - 2022-06-03
...
## [dharitrix-wasm 0.31.1, mandos 0.13.1] - 2022-05-04
- Bugfix - formatter single char issue.

## [dharitrix-wasm 0.31.0, dharitrix-codec 0.11.0, mandos 0.13.0] - 2022-05-02
...
## [dharitrix-wasm 0.30.0, dharitrix-codec 0.10.0] - 2022-03-17
- Feature flags in `dharitrix-wasm`:
...
## [dharitrix-wasm 0.28.0, dharitrix-codec 0.9.0, mandos 0.12.0] - 2022-02-22
- Major dharitrix-codec refactor:
...
## [dharitrix-wasm 0.27.4, dharitrix-codec 0.8.5] - 2022-02-02
- Backwards compatibility fix.

## [dharitrix-wasm 0.27.3] - 2022-01-31
- Backwards compatibility fix.
...
## [dharitrix-wasm 0.26.0] - 2022-01-19
...
## [dharitrix-wasm 0.22.3] - 2021-11-10
- Memory allocation optimisations.

## [dharitrix-wasm 0.22.2] - 2021-11-06
...
## [dharitrix-wasm 0.21.2] - 2021-10-26
- Bugfix regarding contract upgrade args in `dharitrix-wasm-debug`

## [dharitrix-wasm 0.21.1, dharitrix-codec 0.8.1, mandos 0.11.1] - 2021-10-26
- Relative path improvements and fixes in `dharitrix-wasm-debug`:
...
## [dharitrix-wasm 0.21.0, dharitrix-codec 0.8.0, mandos 0.11.0] - 2021-10-22
- Mandos support for NFT syntax. Many more small improvements and some major refactoring.
- Major refactoring of the `dharitrix-wasm-debug` crate, which enables the debugger and the coverage tool. Many features added:
...
## [dharitrix-wasm 0.20.1] - 2021-10-05
...
## [dharitrix-wasm 0.20.0, dharitrix-codec 0.7.0, mandos 0.10.0] - 2021-10-02
...
## [dharitrix-wasm 0.19.1] - 2021-09-17
- Legacy Send API implementation fix

## [dharitrix-wasm 0.19.0, dharitrix-codec 0.6.0, mandos 0.9.0] - 2021-09-10
- Managed types used extensively. Because of this, the recommended Arwen minimum version is `v1.4.10`.
	- Redesigned parts of the dharitrix-codec, so as to allow custom type specializations. These specializations allow serializers and types to bypass the limitations of the codec traits to provide optimized implementations. Managed type serialization relies on this.
...
## [dharitrix-wasm 0.18.2] - 2021-08-20
...
## [dharitrix-wasm 0.18.1] - 2021-08-05
...
## [dharitrix-wasm 0.18.0, mandos 0.8.0] - 2021-07-28
...
- `dharitrix-wasm-derive` now an optional dependency of `dharitrix-wasm`. Use `#[dharitrix_wasm::contract]` instead of `#[dharitrix_wasm_derive::contract]` now. Same for proxies and modules.

## [dharitrix-wasm 0.17.4] - 2021-06-30
- conversions from big ints to small int: `BigUint::to_u64`, `BigInt::to_i64`

## [dharitrix-wasm 0.17.3] - 2021-06-11
- `SingleValueMapper` `set_if_empty` method

## [dharitrix-wasm 0.17.2] - 2021-06-04
- callbacks can now declared in modules only (manual forwarding from the main contract no longer required)

## [dharitrix-wasm 0.17.1] - 2021-06-04
- `legacy-nft-transfer` feature for interacting with older versions of Arwen

## [dharitrix-wasm 0.17.0] - 2021-05-28
...
## [dharitrix-wasm 0.16.2, mandos 0.7.2] - 2021-05-20
...
## [dharitrix-wasm 0.16.1, mandos 0.7.1] - 2021-05-18
- Improvements in mandos-rs: username, contract owner, nested async calls

## [dharitrix-wasm 0.16.0, mandos 0.7.0, dharitrix-codec 0.5.3] - 2021-05-14
...
- We no longer have a separate syntax/parser/code generation for call proxies. They are just contracts with no implementations and annotated with `#[dharitrix_wasm_derive::proxy]` instead of `#[dharitrix_wasm_derive::contract]`.
...
- Minor refactoring in the dharitrix-codec 

## [dharitrix-wasm 0.14.2] - 2021-03-29
- Fixed contract call/callback logs in mandos-rs

## [dharitrix-wasm 0.14.1] - 2021-03-25
- Unified variadic arguments with respective variadic results

## [dharitrix-wasm 0.14.0, mandos 0.6.0, dharitrix-codec 0.5.1] - 2021-03-22
- ESDT functionality:
...
- `dharitrix-codec-derive` dix - `TopDecodeOrDefault` works with generics
- Upgraded to Rust2021.

## [dharitrix-wasm 0.13.0] - 2021-03-04
### Main feature
- Events revamped:
	...
	- topics and data are serialized using the dharitrix-codec instead of the old macro-based solution
	- old events are still allowed for now via the `#[legacy_event("0x...")]` syntax; might be removed in the future
### Refactoring 
- Major refactoring of dharitrix-wasm-derive. This doesn't change much of the functionality, though.
### Minor features
- SingleValueMapper redesigned for easier use. It no longer keeps the storage value cached.

## [dharitrix-wasm 0.12.0] - 2021-02-25
...
## [dharitrix-wasm 0.11.0, dharitrix-codec 0.5.0, mandos 0.5.0] - 2021-02-05
### Refactor
...
- Call Value API refactor and `#[payable]` updates:
	...
	- Refactoring:
    	...
    	- an extensive refactoring of dharitrix-wasm-derive not yet performed, will come soon
### Minor features
...
## [dharitrix-wasm 0.10.5] - 2021-01-27
- Temporary fix: callbacks allow error message argument to be missing

## [dharitrix-wasm 0.10.4, mandos 0.4.2] - 2021-01-13
- Codec derive with defaults
- Storage mapper infrastructure

## [dharitrix-wasm 0.10.3] - 2020-12-29
- ABI generation of endpoint output names

## [dharitrix-wasm 0.10.2, dharitrix-codec 0.4.2] - 2020-12-28
- Codec type hygene

## [dharitrix-wasm 0.10.1, dharitrix-codec 0.4.1, mandos 0.4.1] - 2020-12-23
- Minor fixes, support for strings

## [dharitrix-wasm 0.10.0, dharitrix-codec 0.4.0] - 2020-12-21
- Codec derive
- ABI generation framework
- New example contracts

## [dharitrix-wasm 0.9.8, dharitrix-codec 0.3.2, mandos 0.3.1] - 2020-11-23
- SC deploy API

## [dharitrix-wasm 0.9.7, dharitrix-codec 0.3.1, mandos 0.3.0] - 2020-11-11
...
## [dharitrix-wasm 0.9.6] - 2020-11-09
- H256 & BoxedBytes fixes

## [dharitrix-wasm 0.9.5] - 2020-11-09
- H256 is_zero, minor fixes

## [dharitrix-wasm 0.9.4] - 2020-11-09
- BoxedBytes
	- optimized allocation, used in hooks
	- used for error messages

## [dharitrix-wasm 0.9.3] - 2020-11-08
- Optimized Address/H256 hooks

## [dharitrix-wasm 0.9.2] - 2020-11-06
- Allow slices as arguments 
- `storage_is_empty` annotation

## [dharitrix-wasm 0.9.1] - 2020-11-05
- BigUint serialization bugfix

## [dharitrix-wasm 0.9.0, dharitrix-codec 0.3.0, mandos 0.2.0] - 2020-11-04
...
- Completely ditched the approach from dharitrix-wasm 0.8.0.

## [dharitrix-wasm 0.8.0, dharitrix-codec 0.2.0] - 2020-11-02
...
- 4 crates:
	- dharitrix-wasm
	- dharitrix-wasm-derive for macros
	- dharitrix-wasm-node for wasm
	- dharitrix-wasm-debug for debugging and early tests
